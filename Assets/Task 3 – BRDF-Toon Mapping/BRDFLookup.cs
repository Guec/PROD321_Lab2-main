...
public class BRDFLookup : MonoBehaviour
{
    ...
    ****/
    ...
    void Update()
    {
        ...
        * CalculateBRDFLookupLightingColours function and store the 
        * resulting colour arrays in your mesh's colour array
        * 
        ****/
        meshFilter.mesh.colors = Lighting.CalculateBRDFLookupLightingColours(heightMapTexture, atten, renderingCamera.transform.position, lightSource, meshTransform, meshFilter.mesh.vertices, meshFilter.mesh.normals);
    }
}
